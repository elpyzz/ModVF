...
const variantClasses: Record<Variant, string> = {
  primary: 'bg-primary text-white hover:bg-primary/90 shadow-[0_0_24px_rgba(108,60,225,0.45)]',
  secondary: 'border border-white/20 text-text hover:border-primary/60',
